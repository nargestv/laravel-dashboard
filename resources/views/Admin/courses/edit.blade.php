...
@section('script')
    ...
    <script>
        CKEDITOR.replace('body', {
         ...
         //   filebrowserImageBrowseLinkUrl: '/admin/panel/upload-image',
        })
    </script>
@endsection
@section('content')
        ...
        <form class="form-horizontal" action="{{ route('courses.update' , [$course->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <textarea rows="5" class="form-control" name="description" id="description" placeholder="توضیحات را وارد کنید">{{ $course->description }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
