        ...
        <form class="form-horizontal" action="{{ route('courses.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <textarea rows="5" class="form-control" name="body" id="body" placeholder="متن دوره را وارد کنید">{{ old('body') }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="images" class="control-label">تصویر دوره</label>
                    <input type="file" class="form-control" name="images" id="images" placeholder="تصویر دوره را وارد کنید" value="{{serialize(old('images'))}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6">
        ...
        <div class="large-12 columns">
            <div class="left-text left">
                <div class="inner-block">
                    <?php //echo zella_tiny_account(false); ?>
                </div>
            </div>
            <div class="right-text right">
                <div class="topbar-menu-container">
                    <?php /*//do_action('nasa_support_multi_languages'); */?>
                    <?php //echo zella_str($nasa_topbar_icons); ?>
                </div>
            </div>
        </div>
    </div>
