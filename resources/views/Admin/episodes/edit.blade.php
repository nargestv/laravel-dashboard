...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form class="form-horizontal" action="{{ route('episodes.update' , [$episode->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="course_id" class="control-label">دوره مرتبط ویدیو</label>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <textarea rows="5" class="form-control" name="description" id="description" placeholder="متن ویدیو را وارد کنید">{{ $episode->description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="time" id="time" placeholder=" لینک را وارد کنید" value="{{ $episode->time }}">
                </div>
                <div class="col-sm-6">
                    <label for="number" class="control-label">شماره قسمت</label>
                    <input type="text" class="form-control" name="number" id="number" placeholder="شماره قسمت را وارد کنید" value="{{ $episode->number }}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6">
