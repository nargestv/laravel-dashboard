        ...
        <form class="form-horizontal" action="{{ route('episodes.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <textarea rows="5" class="form-control" name="description" id="description" placeholder="متن ویدیو را وارد کنید">{{ old('description') }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="time" id="time" placeholder=" لینک را وارد کنید" value="{{ old('time"') }}">
                </div>
                <div class="col-sm-6">
